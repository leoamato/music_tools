...
for i in range (0,12):
	test = tell_3chord (notes[i], intervals_calculator(notes[i], "3m", "asc"), intervals_calculator(notes[i], "5j", "asc"))
	expected = build_3chord (notes[i], "m")
...
for i in range (0,12):
	test = tell_3chord (notes[i], intervals_calculator(notes[i], "3m", "asc"), intervals_calculator(notes[i], "5dim", "asc"))
	expected = build_3chord (notes[i], "dim")
...
for i in range (0,12):
	test = tell_3chord (notes[i], intervals_calculator(notes[i], "3M", "asc"), intervals_calculator(notes[i], "6m", "asc"))
	expected = build_3chord (notes[i], "aum")
